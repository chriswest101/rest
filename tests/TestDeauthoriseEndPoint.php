<?php
	...
	*/
	...
	echo " - Calling http://rest.christophermwest.co.uk/user/deauthorise<br/>";
	$url = "http://rest.christophermwest.co.uk/user/deauthorise";
	$fields = array(
			'clientId' 				=> urlencode("1"),
			'clientSecurityCode' 	=> urlencode("57c2b1b5e73d5"),
			'token'					=> json_decode($token)
	);
	$token = performCurl($url, $fields, "DELETE");

	echo " - Result for deauthorise end point ".print_r($token, true)."<br/>";
